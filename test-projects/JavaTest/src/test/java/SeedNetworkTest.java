...
public class SeedNetworkTest {
    ...
    public void neuralNetworkPrediction() {
        double[] expected = {0.1955367616220067, 0.29453217823829403, 0.48811285629821577};
    ...
    public void neuralNetworkNormalErrors() {
        double[] expected = {0.03084857932439276, 0.017352325869970923, 0.015767048227069706, 0.014689784988482587};
        assertArrayEquals(
                expected,
    ...
    LazyList fitNetwork = NeuralNetwork$.MODULE$.fit(neuralNetwork, learningRate, inputValues, expectedOutput);

    @Test
    public void fitNeuralNetworkPrediction() {
        double[] expected = {0.21003023182099667, 0.2720325964336182, 0.44366449684542975};
        assertArrayEquals(
                expected,
                NeuralNetwork$.MODULE$.prediction(fitNetwork, inputValues),
                0.0
        );
    }
