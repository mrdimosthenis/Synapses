...
namespace CSharpTest
{
    public class SeedNetworkTest
    {
        ...
        {
            double[] expected = {0.6529507583630635, 0.4969049184756722, 0.703216064707541};
        ...
        {
            double[] expected =
                {0.0011183892036199091, 0.000629093927036199, 0.0005716210242513755, 0.0005325657548717646};
            Assert.Equal(
                expected,
        ...
        {
            double[] expected = {0.6450667577380073, 0.5334422676540814, 0.6770163620559069};
